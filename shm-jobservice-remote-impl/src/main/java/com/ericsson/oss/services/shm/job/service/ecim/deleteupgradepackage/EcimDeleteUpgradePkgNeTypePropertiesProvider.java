 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.oss.services.shm.job.service.ecim.deleteupgradepackage;
 ...
 */
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.ECIM, jobType = com.ericsson.oss.services.shm.job.activity.JobType.DELETE_UPGRADEPACKAGE)
public class EcimDeleteUpgradePkgNeTypePropertiesProvider implements NeTypePropertiesProvider {
    ...
    public List<Map<String, Object>> getNeTypeProperties(final List<String> activityProperties, final ShmRemoteJobData shmRemoteJobData) {
        ...
        propertieslist.add(neTypePropertiesHelper.createPropertyMap(JobPropertyConstants.DELETE_REFERRED_BACKUPS, shmDeleteUpgradePkgJobData.getDeleteReferredBackups()));
