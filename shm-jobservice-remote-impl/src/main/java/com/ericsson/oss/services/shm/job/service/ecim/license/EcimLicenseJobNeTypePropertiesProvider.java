...
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.ECIM, jobType = com.ericsson.oss.services.shm.job.activity.JobType.LICENSE)
public class EcimLicenseJobNeTypePropertiesProvider implements NeTypePropertiesProvider {
