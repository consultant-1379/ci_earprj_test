...
/**
 * This class is to get the job configuration details of Upgrade Job when vRAN specific node is selected, which to be displayed on Node activities panel of job details page
 * 
 */
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.vRAN, jobType = JobType.UPGRADE)
public class UpgradeJobDetailsProvider implements JobTypeDetailsProvider {
    ...
    static {
        acitvityParameters.put(CONFIRM, Arrays.asList(JobPropertyConstants.POST_ACTIVATE_CHECK_FAILED));
    }
