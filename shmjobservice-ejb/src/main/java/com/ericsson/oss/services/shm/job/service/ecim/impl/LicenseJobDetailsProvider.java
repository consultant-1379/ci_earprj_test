 ...
 */
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.ECIM, jobType = JobType.LICENSE)
public class LicenseJobDetailsProvider implements JobTypeDetailsProvider {
    ...
    public List<Map<String, String>> getJobConfigurationDetails(final Map<String, Object> jobConfigurationDetails, final PlatformTypeEnum platformType, final String neType, final String neName) {
        ...
        String licenseKeyFileName = licenseKeyFilePath != null ? licenseKeyFilePath.substring(licenseKeyFilePath.lastIndexOf('/') + 1, licenseKeyFilePath.length()) : "";
        LOGGER.debug("ECIM Node activites licenseKeyFileName {} ", licenseKeyFileName);
