...
/**
 * This class is to get the job configuration details of License Job when Mini-Link-Outdoor specific node is selected, which to be displayed on Node activities panel of job details page
 * 
 */
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.MINI_LINK_OUTDOOR, jobType = JobType.LICENSE)
public class LicenseJobDetailsProvider implements JobTypeDetailsProvider {
    ...
    public List<Map<String, String>> getJobConfigurationDetails(final Map<String, Object> jobConfigurationDetails, final PlatformTypeEnum platformType, final String neType, final String neName) {
        ...
        LOGGER.debug("Mini-Link-Outdoor Node activites licenseKeyFileName {} ", licenseKeyFileName);
