...
@ApplicationScoped
@PlatformJobTypeAnnotation(platformType = PlatformTypeEnum.CPP, jobType = JobType.BACKUP_HOUSEKEEPING)
public class BackupHousekeepingJobDetailsProvider implements JobTypeDetailsProvider {
    ...
    static {
        acitvityParameters.put(CLEAN_CV, Arrays.asList(JobPropertyConstants.CLEAR_ALL_BACKUPS, JobPropertyConstants.CLEAR_ELIGIBLE_BACKUPS, JobPropertyConstants.BACKUPS_TO_KEEP_IN_ROLLBACK_LIST,
                JobPropertyConstants.MAX_BACKUPS_TO_KEEP_ON_NODE));
    }
