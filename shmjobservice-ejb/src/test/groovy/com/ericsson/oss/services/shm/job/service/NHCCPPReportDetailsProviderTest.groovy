...
import com.ericsson.oss.services.shm.job.service.cpp.impl.NHCCPPReportDetailsProvider
...
class NHCCPPReportDetailsProviderTest extends CdiSpecification{


    @ObjectUnderTest
    NHCCPPReportDetailsProvider objectUnderTest;
    ...
    def "get jobConfiguration parameter Details"(){
        ...
        JobConfigurationDetails response=objectUnderTest.getJobConfigParamDetails(jobConfigurationParamDetails, "ERBS");
        objectUnderTest.getJobConfigurationDetails(jobConfigurationDetails, PlatformTypeEnum.CPP, "ERBS", "LTE100ERBS00001")
        then:"Getting configuration parameters details properly"
        assert (response.getNeType()=="ERBS");
    ...
    def "get jobConfiguration details"(){
        ...
        response=objectUnderTest.getJobConfigurationDetails(jobConfigurationDetails, PlatformTypeEnum.CPP, "ERBS", "LTE0ERBS00001")
    ...
    def buildJobConfigurationDetails() {
        ...
        activityNhc.setPlatform(PlatformTypeEnum.CPP)
        activityNhc.setOrder(1);
        activityNhc.setNeType("ERBS")
        Activity activityEnm=new Activity();
        activityEnm.setName("enmhealthcheck");
        activityEnm.setPlatform(PlatformTypeEnum.CPP)
        activityEnm.setOrder(1);
        activityEnm.setNeType("ERBS")
