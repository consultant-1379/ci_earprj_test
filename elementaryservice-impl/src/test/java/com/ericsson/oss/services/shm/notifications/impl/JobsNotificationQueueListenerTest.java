...
public class JobsNotificationQueueListenerTest {

    @InjectMocks
    ShmNotificationQueueListener jobsNotificationQueueListener;
    ...
    public void onMessageTest() {
        jobsNotificationQueueListener.onMessage(message);
        verify(notificationReciever, times(0)).notify(dpsAttributeChangedEvent, new Date());
    }

    @Test
    public void onMessageTestWithDpsAttributeChangedEvent() {
        jobsNotificationQueueListener.onMessage(dpsAttributeChangedEvent);
