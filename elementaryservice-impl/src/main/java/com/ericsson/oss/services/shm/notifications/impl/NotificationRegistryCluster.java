...
/**
 * Distributed cache for registering observers(job-type) for avc events.
 */
@ApplicationScoped
@NotificationTypeQualifier(type = NotificationType.JOB)
public class NotificationRegistryCluster extends AbstractNotificationRegistry implements NotificationRegistry {
