...
import com.ericsson.oss.mediation.shm.model.request.StnUpgradeJobEndMediationTaskRequest;
/**
 * 
 * Service to send mediation task request to perform STN Software upgrade_end/abort
 * 
 * @author xsamven
 */
public class StnSoftwareEndUpgradeEventSender {

    private final Logger logger = LoggerFactory.getLogger(StnSoftwareEndUpgradeEventSender.class);
    
    @Inject
    @Modeled
    private EventSender<StnUpgradeJobEndMediationTaskRequest> actionInvocationRequestSender;
    ...
    public void sendSoftwareUpgradeActionRequest(final long activityJobId, final String activityName, final String nodeAddress, final Map<String, Object> eventAttributes) {
    	...
    	final StnUpgradeJobEndMediationTaskRequest activityInitiateRequest = new StnUpgradeJobEndMediationTaskRequest();
