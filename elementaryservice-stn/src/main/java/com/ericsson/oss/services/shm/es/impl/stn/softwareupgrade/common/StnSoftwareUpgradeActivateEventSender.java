...
import com.ericsson.oss.mediation.shm.model.request.StnUpgradeJobMediationTaskRequestActivate;
/**
 * 
 * Service to send mediation task request to perform STN Software upgrade_activate job
 * 
 * @author xsamven
 */
public class StnSoftwareUpgradeActivateEventSender {
    
    private final Logger logger = LoggerFactory.getLogger(StnSoftwareEndUpgradeEventSender.class);
    
    @Inject
    @Modeled
    private EventSender<StnUpgradeJobMediationTaskRequestActivate> actionInvocationRequestSender;
    ...
    public void sendSoftwareUpgradeActionRequest(final long activityJobId, final String activityName, final String nodeAddress, final Map<String, Object> eventAttributes) {
    	...
    	final StnUpgradeJobMediationTaskRequestActivate activityInitiateRequest = new StnUpgradeJobMediationTaskRequestActivate();
