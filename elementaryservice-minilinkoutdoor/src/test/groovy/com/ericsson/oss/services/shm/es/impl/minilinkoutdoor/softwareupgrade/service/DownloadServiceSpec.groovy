...
class DownloadServiceSpec extends CdiSpecification {
    ...
    def setup() {
        ...
        activityUtils.getActivityInfo(activityJobId, DownloadService.class) >> jobActivityInfo;
    ...
    def "testCancel" () {
        ...
        when: "invoke cancel"
        ActivityStepResult activityStepResultA = downloadService.cancel(activityJobId);
    ...
    def "testPreCheck"() {
        ...
        ActivityStepResult activityStepResult = downloadService.precheck(activityJobId);
        then: "return value should not be null"
    ...
    def "testExecute"() {
        when: "invoke execute"
        downloadService.execute(activityJobId)
        then : "expect nothing"
    }
    ...
    def "testCancelTimeout"() {
        ...
        ActivityStepResult activityStepResult = downloadService.cancelTimeout(activityJobId, true);
        then: "return value should not be null"
        Assert.notNull(activityStepResult)
    }
    ...
    def "testHandleTimeout"() {
        ...
        ActivityStepResult activityStepResultA = downloadService.handleTimeout(activityJobId);
        then: "return value should not be null"
        Assert.notNull(activityStepResultA)
    ...
    def 'testprocessNotification'() {
        ...
        downloadService.processNotification(message)
        then: "return value should not be null"
        if(state == "DOWNLOADED") {
