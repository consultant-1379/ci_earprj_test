...
class ConfirmServiceSpec extends CdiSpecification {
    ...
    def "testCancel" () {
        ...
        when: "invoke cancel"
        ActivityStepResult activityStepResultA = confirmService.cancel(activityJobId);
    ...
    def "testCancelTimeout"() {
        ...
        ActivityStepResult activityStepResult = confirmService.cancelTimeout(activityJobId, true);
        then: "return value should not be null"
        Assert.notNull(activityStepResult)
    }
    ...
    def "testHandleTimeout"() {
        ...
        ActivityStepResult activityStepResultA = confirmService.handleTimeout(activityJobId);
        then: "return value should not be null"
        Assert.notNull(activityStepResultA)
    ...
    def 'testprocessNotification'() {
        ...
        confirmService.processNotification(message)
        then: "return value should not be null"
        if(state == "DOWNLOADED") {
