...
public class ActivateServiceTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateServiceTest.class);
    ...
    public void testPrecheck() {
        when(activityUtils.getActivityInfo(ACTIVITY_JOB_ID, ActivateService.class)).thenReturn(jobActivityInfo);
        ...
        final ActivityStepResult result = activateService.precheck(ACTIVITY_JOB_ID);
    ...
    public void testExecute() {
        try {
            ...
            final String subscriptionKey = DELIMETER + NETWORKELEMENT + NODE_NAME + DELIMETER + ActivityConstants.ACTIVATE + DELIMETER;
            ...
            activateService.execute(ACTIVITY_JOB_ID);
    ...
    public void testHandleTimeout() {
        ...
        final ActivityStepResult result = activateService.handleTimeout(ACTIVITY_JOB_ID);
    ...
    public void testCancel() throws JobDataNotFoundException {
        ...
        final ActivityStepResult result = activateService.cancel(ACTIVITY_JOB_ID);
        assertEquals(ActivityStepResultEnum.EXECUTION_FAILED, result.getActivityResultEnum());
    }

    @Test
    public void testCancelTimeout() {
        activateService.cancelTimeout(ACTIVITY_JOB_ID, true);
    }
}
