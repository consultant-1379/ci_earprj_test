...
public class DownloadServiceTest {
    ...
    private static final String THIS_ACTIVITY = "download";
    private static final long ACTIVITY_JOB_ID = 123;
    private static final String NODE_NAME = "ML-TN";

    @Test
    public void testPrecheck() {
        when(activityUtils.getActivityInfo(ACTIVITY_JOB_ID, DownloadService.class)).thenReturn(jobActivityInfo);
        ...
        final ActivityStepResult result = downloadService.precheck(ACTIVITY_JOB_ID);
    ...
    public void testExecute() {
        try {
            ...
            final String subscriptionKey = DELIMETER + NETWORKELEMENT + NODE_NAME + DELIMETER + ActivityConstants.DOWNLOAD + DELIMETER;
            ...
            downloadService.execute(ACTIVITY_JOB_ID);
    ...
    public void testProcessNotificationSuccess() {
        ...
        when(activityUtils.getActivityInfo(ACTIVITY_JOB_ID, DownloadService.class)).thenReturn(jobActivityInfo);
        downloadService.processNotification(notification);
    }
    ...
    public void testHandleTimeout() {
        ...
        final ActivityStepResult result = downloadService.handleTimeout(ACTIVITY_JOB_ID);
    ...
    public void testCancel() throws JobDataNotFoundException {
        ...
        final ActivityStepResult result = downloadService.cancel(ACTIVITY_JOB_ID);
        assertEquals(ActivityStepResultEnum.EXECUTION_FAILED, result.getActivityResultEnum());
    }

    @Test
    public void testCancelTimeout() {
        downloadService.cancelTimeout(ACTIVITY_JOB_ID, true);
    }
}
