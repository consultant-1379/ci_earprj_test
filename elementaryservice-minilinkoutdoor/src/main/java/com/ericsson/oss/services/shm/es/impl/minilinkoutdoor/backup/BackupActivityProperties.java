 ...
 * It should be instantiated with the getBackupActivityProperties methods in the BackupUtil class as this requires the usage of the ActivityUtils
 * bean.
 */
public class BackupActivityProperties {
    ...
    public BackupActivityProperties(final long activityJobId, final JobEnvironment jobEnvironment, final String backupName,
                                    final String activityName, final Class<?> activityServiceClass) {
    ...
    public String getBackupFileWithPath() {
        return getNodeName() + "/" + getBackupFileName();
    }
