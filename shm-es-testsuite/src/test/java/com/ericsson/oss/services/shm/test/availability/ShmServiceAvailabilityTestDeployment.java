 ...
 * @author xmanush
 */
public class ShmServiceAvailabilityTestDeployment {
    ...
    private static final String SHM_COMMON = "com.ericsson.oss.services.shm:shm-common-utilities";
    ...
    //private static final String LICENSE_SERVICE_EJB = "com.ericsson.oss.services.shm:licenseservice-ejb";
    ...
    //private static final String FILE_STORE_REMOTE_API = "com.ericsson.oss.services.shm:filestore-softwarepackage-remote-api";
    private static final String SHM_MODELS_MODEL = "com.ericsson.oss.services.shm.models:shm-models-model";
    private static final String SHM_VERSANT_LISTENER = "com.ericsson.oss.services.shm:shm-dps-notification-listener-ejb";
    ...
    public static WebArchive createTestDeploymentForES() {
        ...
        //webArchive.addAsLibraries(resolveFilesWithTransitiveDependencies(FILE_STORE_REMOTE_API));
        ...
        webArchive.addAsLibraries(resolveFilesWithTransitiveDependencies(SHM_VERSANT_LISTENER));
        ...
        webArchive.addAsLibraries(IntegrationTestDeploymentFactoryBase.resolveAsFiles(TestConstants.SHM_GROUP_ID, TestConstants.BACKUP_SERVICE_REMOTE_IMPL_ARTIFACT_ID, "pom.xml")[0]);
        ...
        webArchive.addClasses(DataPersistenceServiceProxy.class, DataPersistenceServiceProxyBean.class, ShmServiceAvailabilityTestBase.class, UpgradeEventHandler.class);
        return webArchive;
    }
    ...
    public static WebArchive createModuleArchiveForSMRSIDM() {
        final WebArchive smrsIdmWar = ShrinkWrap.create(WebArchive.class, "smrsidm-test.war").addClass(SmrsServiceMock.class)/* .addClass(IdentityManagementServiceMock.class) */
                .addAsResource(IntegrationTestDeploymentFactoryBase.BEANS_XML_FILE).addAsLibraries(resolveFilesWithTransitiveDependencies(SMRS_SERVICE_API))
                .addAsLibraries(resolveFilesWithTransitiveDependencies(IDENTITYMGMTSERVICE_API));
        return smrsIdmWar;
    }
}
