...
public class TestDataGenerator {
    ...
    @Inject
    private ITestBase availabilityDataBean;
    ...
    public void prepareLicenseJobData(final String activityName) {
        ...
        availabilityDataBean.createJobDetails(JobTypeEnum.LICENSE, jobProperties, activityName);
    }
    ...
    public PersistenceObject prepareLicensePOTestData() {
        ...
        final PersistenceObject licenseDataPO = availabilityDataBean.preparePOTestData(LicensingActivityConstants.LICENSE_DATA_PO_NAMESPACE, LicensingActivityConstants.LICENSE_DATA_PO,
                licenseAttributes);
        return licenseDataPO;
    }

    public ManagedObject prepareBaseMOTestData() throws Throwable {
        final ManagedObject createdManagedElementMO = availabilityDataBean.prepareBaseMOTestData();
        return createdManagedElementMO;
    }

    public void prepareLicensingMOTestData() throws Throwable {
        final ManagedObject createdSystemFunctionMO = availabilityDataBean.createSystemFunctionMO(prepareBaseMOTestData());
    ...
    private ManagedObject createLicensingMO(final Map<String, Object> licensingMOAttributesMap, final ManagedObject parent) {
        final ManagedObject licensingMO = availabilityDataBean.createChildMO("1", LicensingActivityConstants.LICENSE_MO, parent, TestConstants.ERBS_NODE_MODEL_NAMESPACE, parent.getVersion(),
