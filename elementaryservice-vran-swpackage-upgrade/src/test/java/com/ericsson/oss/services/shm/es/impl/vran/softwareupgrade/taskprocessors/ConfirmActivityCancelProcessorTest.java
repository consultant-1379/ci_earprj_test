...
public class ConfirmActivityCancelProcessorTest extends CancelTaskTestBase {

    @InjectMocks
    private ConfirmActivityCancelProcessor confirmActivityCancelProcessor;

    @Test
    public void testProcessCancelForUnSupportedActivity() {
        ...
        confirmActivityCancelProcessor.processCancelForUnSupportedActivity(jobActivityInfo);
    }
