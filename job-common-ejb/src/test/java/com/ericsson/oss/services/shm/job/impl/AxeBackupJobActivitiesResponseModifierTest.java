...
public class AxeBackupJobActivitiesResponseModifierTest {

    @InjectMocks
    private AxeBackupJobActivitiesResponseModifier objectUnderTest;

    @Mock
    private JobActivitiesResponse jobActivitiesResponseMock;

    @Mock
    private List<Activity> activityListMock;

    @Mock
    private ListIterator<Activity> activityListIteratorMock;
