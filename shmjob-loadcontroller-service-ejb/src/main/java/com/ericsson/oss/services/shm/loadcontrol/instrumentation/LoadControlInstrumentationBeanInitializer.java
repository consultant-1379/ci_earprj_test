...
@Singleton
@Startup
public class LoadControlInstrumentationBeanInitializer {


    @Inject
    LoadControlInstrumentationBean instrumentationBean;
    ...
    public void init() {
        ...
        instrumentationBean.getCurrentCounts();
        instrumentationBean.getCurrentThresholdCounts();
